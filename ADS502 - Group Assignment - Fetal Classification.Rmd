...
#### fetal_health logistic regression before resampling
```{r logreg}
...
logreg01 <- glm(formula = fetal_health ~ prolongued_decelerations + abnormal_short_term_variability + percentage_of_time_with_abnormal_long_term_variability + accelerations + histogram_mode + mean_value_of_long_term_variability + histogram_variance + uterine_contractions, data = train_fetal_rebal, family = binomial)
summary(logreg01)

logreg01_test <- glm(formula =fetal_health ~ prolongued_decelerations + abnormal_short_term_variability + percentage_of_time_with_abnormal_long_term_variability + accelerations + histogram_mode + mean_value_of_long_term_variability + histogram_variance + uterine_contractions, data = fetal_test, family = binomial)
summary(logreg01_test)



```
### All coefficients are statistically significant except for histogram_variance and mean_value_of_long_term_variability
###For every one unit change in histogram variance, the log odds of fetal health increases by 0.1354
...
#diagonals are correctly classified
